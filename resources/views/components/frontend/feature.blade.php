    ...
    <div class="container pb-5">
        ...
        <div class="row">
            ...
            {{-- <div class="col-md-4 categories-item p-4 border-none">
                <div class="categories-item-inner">
                    <div class="categories-img rounded-top">
                        <img src="{{ asset('frontend/assets/img/car-2.png') }}" class="img-fluid w-100 rounded-top" alt="">
                    </div>
                    <div class="categories-content rounded-bottom p-4">
            ...
            <div class="col-md-4 categories-item p-4 border-none">
                <div class="categories-item-inner">
                    <div class="categories-img rounded-top">
                        <img src="{{ asset('frontend/assets/img/car-3.png') }}" class="img-fluid w-100 rounded-top" alt="">
                    </div>
                    <div class="categories-content rounded-bottom p-4">
            ...
            <div class="col-md-4 categories-item p-4 border-none">
                <div class="categories-item-inner">
                    <div class="categories-img rounded-top">
                        <img src="{{ asset('frontend/assets/img/car-4.png') }}" class="img-fluid w-100 rounded-top" alt="">
                    </div>
                    <div class="categories-content rounded-bottom p-4">
            ...
            <div class="col-md-4 categories-item p-4 border-none">
                <div class="categories-item-inner">
                    <div class="categories-img rounded-top">
                        <img src="{{ asset('frontend/assets/img/car-1.png') }}" class="img-fluid w-100 rounded-top" alt="">
                    </div>
                    <div class="categories-content rounded-bottom p-4">
