    ...
    @endif
        ...
        <form action="{{ route('admin.cars.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="carName" name="name" placeholder="Enter Car Name" value="{{ old('name') }}" required>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="price" name="daily_rent_price" value="{{ old('daily_rent_price') }}" required>
          </div>
          ...
          <!-- Submit Button -->
          <button type="submit" class="btn btn-success btn-block">Save Car</button>
        </form>
      </div>
    </div>
