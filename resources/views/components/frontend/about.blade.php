        ...
        <div class="row g-5">
            <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="about-item">
                    <div class="pb-5">
                        <h1 class="display-5 text-capitalize">SwiftWheels <span class="text-primary">About</span></h1>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="about-item-inner border p-4">
                                <div class="about-icon mb-4">
                                    <img src="{{ asset('frontend/assets/img/about-icon-1.png') }}" class="img-fluid w-50 h-50" alt="Icon">
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="about-item-inner border p-4">
                                <div class="about-icon mb-4">
                                    <img src="{{ asset('frontend/assets/img/about-icon-2.png') }}" class="img-fluid h-50 w-50" alt="Icon">
                                </div>
            ...
            <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                <div class="about-img">
                    <div class="img-1">
                        <img src="{{ asset('frontend/assets/img/about-img.jpg') }}" class="img-fluid rounded h-100 w-100" alt="">
                    </div>
                </div>
            </div>
        </div>
